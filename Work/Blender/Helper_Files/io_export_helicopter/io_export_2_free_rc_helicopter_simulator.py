...
bl_info = {
    ...
    "version": (1, 1, 0),
    "blender": (2, 91, 00),
    "location": "File > Export > Free-RC_Helicopter-Simulator",
    "description": "Export to Free-RC-Helicopter-Simulator",
    "warning": "",
    "wiki_url": "x",
...
def export_objects():
	...
	target_folder_relative = '\\Free-RC-Helicopter-Simulator\\Free-RC-Helicopter-Simulator\\Assets\\Helicopters_Available'
	scale = 1.0
	######################################################################################
	...
	######################################################################################
	def export_rotor_as_obj(collection_name, object_name, empty_name, scale, ascii_file):
		bpy.ops.object.mode_set(mode='OBJECT')
		bpy.ops.object.select_all(action='DESELECT')
	...
	export_rotor_as_obj('MAINROTOR_EXPORT', 'Mainrotor', 'Empty_Mainrotor', scale, f)
	export_rotor_as_obj('TAILROTOR_EXPORT', 'Tailrotor', 'Empty_Tailrotor', scale, f)
	export_rotor_as_obj('PROPELLER_EXPORT', 'Propeller', 'Empty_Propeller', scale, f)
	export_rotor_as_obj('MOTOR_EXPORT', 'Motor', 'Empty_Motor', scale, f)
	f.close()
	
	export_model_as_fbx('SETUP_000_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_000\\Prefabs\\' + name_in_unity + '_setup_000.fbx', scale)
	export_model_as_fbx('SETUP_001_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_001\\Prefabs\\' + name_in_unity + '_setup_001.fbx', scale)
	export_model_as_fbx('SETUP_002_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_002\\Prefabs\\' + name_in_unity + '_setup_002.fbx', scale)
	export_model_as_fbx('SETUP_003_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_003\\Prefabs\\' + name_in_unity + '_setup_003.fbx', scale)
	export_model_as_fbx('SETUP_004_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_004\\Prefabs\\' + name_in_unity + '_setup_004.fbx', scale)
	export_model_as_fbx('SETUP_005_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_005\\Prefabs\\' + name_in_unity + '_setup_005.fbx', scale)
	export_model_as_fbx('SETUP_006_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_006\\Prefabs\\' + name_in_unity + '_setup_006.fbx', scale)
	export_model_as_fbx('SETUP_007_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_007\\Prefabs\\' + name_in_unity + '_setup_007.fbx', scale)
	export_model_as_fbx('SETUP_008_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_008\\Prefabs\\' + name_in_unity + '_setup_008.fbx', scale)
	export_model_as_fbx('SETUP_009_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_009\\Prefabs\\' + name_in_unity + '_setup_009.fbx', scale)
	...
	export_model_as_fbx('SKIDS_LEFT_SETUP_000_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_000\\Prefabs\\' + name_in_unity + '_setup_000_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_000_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_000\\Prefabs\\' + name_in_unity + '_setup_000_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_001_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_001\\Prefabs\\' + name_in_unity + '_setup_001_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_001_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_001\\Prefabs\\' + name_in_unity + '_setup_001_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_002_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_002\\Prefabs\\' + name_in_unity + '_setup_002_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_002_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_002\\Prefabs\\' + name_in_unity + '_setup_002_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_003_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_003\\Prefabs\\' + name_in_unity + '_setup_003_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_003_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_003\\Prefabs\\' + name_in_unity + '_setup_003_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_004_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_004\\Prefabs\\' + name_in_unity + '_setup_004_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_004_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_004\\Prefabs\\' + name_in_unity + '_setup_004_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_005_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_005\\Prefabs\\' + name_in_unity + '_setup_005_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_005_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_005\\Prefabs\\' + name_in_unity + '_setup_005_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_006_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_006\\Prefabs\\' + name_in_unity + '_setup_006_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_006_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_006\\Prefabs\\' + name_in_unity + '_setup_006_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_007_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_007\\Prefabs\\' + name_in_unity + '_setup_007_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_007_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_007\\Prefabs\\' + name_in_unity + '_setup_007_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_008_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_008\\Prefabs\\' + name_in_unity + '_setup_008_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_008_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_008\\Prefabs\\' + name_in_unity + '_setup_008_Gear_Or_Skid_Animation_Right.fbx', scale)
	export_model_as_fbx('SKIDS_LEFT_SETUP_009_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_009\\Prefabs\\' + name_in_unity + '_setup_009_Gear_Or_Skid_Animation_Left.fbx', scale)
	export_model_as_fbx('SKIDS_RIGHT_SETUP_009_EXPORT', '\\Resources\\' + name_in_unity + '_Setup_009\\Prefabs\\' + name_in_unity + '_setup_009_Gear_Or_Skid_Animation_Right.fbx', scale)
	...
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\3D_Fuselage\SikorskyS61_Fuselage.obj"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\3D_Mainrotor\SikorskyS61_Mainrotor.obj"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\3D_Tailrotor\SikorskyS61_Tailrotor.obj"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\Resources\SikorskyS61_Setup_000\Prefabs\SikorskyS61_setup_000.fbx"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\Resources\SikorskyS61_Setup_001\Prefabs\SikorskyS61_setup_001.fbx"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\Animation\SikorskyS61_Doors_Animation.fbx"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\Animation\SikorskyS61_Gear_Or_Support_Animation_Steering_Center.fbx"
	##"F:\Helikopter\UNITY\GitHub\Free-RC-Helicopter-Simulator_\Assets\Helicopters_Available\SikorskyS61\Animation\SikorskyS61_Gear_Or_Skid_Animation_Right.fbx"
...
## Operator
#################################################################################
class EXPORT_FREE_RC_HELICOPTER_SIMULATOR_OT_objects(Operator):
	"""EXPORT Free Rc Helicopter Simulator objects"""          # use this as a tooltip for menu items and buttons.

	bl_idname = "export_free_rc_helicopter_simulator.objects"  # unique identifier for buttons and menu items to reference.
	bl_label = "Export Free-RC-Helicopter-Simulator objects"   # display name in the interface.
...
## Register
#################################################################################
def export_free_rc_helicopter_simulator_objects_button(self, context):
    self.layout.operator(EXPORT_FREE_RC_HELICOPTER_SIMULATOR_OT_objects.bl_idname, text="Export Free-RC-Helicopter-Simulator Objects", icon='IMAGE_DATA')


classes = (
    EXPORT_FREE_RC_HELICOPTER_SIMULATOR_OT_objects,
)
...
def register():
    ...
    bpy.types.TOPBAR_MT_file_export.append(export_free_rc_helicopter_simulator_objects_button)


def unregister():
    bpy.types.TOPBAR_MT_file_export.remove(export_free_rc_helicopter_simulator_objects_button)
