...
namespace Common
{
    ...
    public static class Helper
    {
        ...
        /// (untiy's standard is (with Quaternion.Euler()) S312 == B123, left handed, space fixed) 
        /// </summary>
        /// <param name="angles"></param>
        /// <returns></returns>
        // ############################################################################
        ...
        public static float Point_To_Triangle_Distance(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 normal, Vector3 point)
        {
            Vector3 E0 = vertex1 - vertex0;
            Vector3 E1 = vertex2 - vertex0;
            Vector3 D = vertex0 - point; // D = B - P
